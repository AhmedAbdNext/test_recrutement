...
import {getBoxHight , convertTimeToNumber, sortInterval, isOverlapping, transformPayload, removeRedundancy,
     sortMatrix, dayByMinntes, getOverLappingMatrixIds } from './times';
...
const customOverlappingPayload = [
    {
        id:1,
        start: "09:00",
        duration: 270
...
test('should show by minutes', () => {
    ...
    expect(dayByMinntes(15)).toEqual([
        ...
        [ '00:45', '01:00' ], [ '01:00', '01:15' ], [ '01:15', '01:30' ],
        [ '01:30', '01:45' ], [ '01:45', '02:00' ], [ '02:00', '02:15' ],
        [ '02:15', '02:30' ], [ '02:30', '02:45' ], [ '02:45', '03:00' ],
        [ '03:00', '03:15' ], [ '03:15', '03:30' ], [ '03:30', '03:45' ],
        [ '03:45', '04:00' ], [ '04:00', '04:15' ], [ '04:15', '04:30' ],
        [ '04:30', '04:45' ], [ '04:45', '05:00' ], [ '05:00', '05:15' ],
        [ '05:15', '05:30' ], [ '05:30', '05:45' ], [ '05:45', '06:00' ],
        [ '06:00', '06:15' ], [ '06:15', '06:30' ], [ '06:30', '06:45' ],
        [ '06:45', '07:00' ], [ '07:00', '07:15' ], [ '07:15', '07:30' ],
        ...
        [ '22:30', '22:45' ], [ '22:45', '23:00' ], [ '23:00', '23:15' ],
